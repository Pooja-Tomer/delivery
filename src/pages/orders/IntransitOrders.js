...
export default function IntransitOrders(props) {
    ...
    ApiClient.PostApi(ApiUrl.OrdersCSV, partner).then((value) => {
      if (value !== null) {
        if (value.status === "success") {
          ...
          setCsvData(value.out_for_delivered_orders);
  ...
  return (
    ...
    <div className="card-box"><div className="container p-0">
        <div className="row search-box ">
          <h4 className="protitle mb-0">Intransit Orders</h4>
          <div className="text-right">
              <CSVLink
                headers={headers}
                data={csvData}
                filename={"IntransitOrdersCargillDelivery.csv"}
                ref={csvLinkEl}
              >
                <button
                  type="button"
