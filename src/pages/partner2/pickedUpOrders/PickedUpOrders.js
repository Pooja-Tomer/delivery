...
export default function AgentPickedUpOrders(props) {
      ...
      ApiClient.PostApi(ApiUrl.AgentOrdersCSV, agent).then((value) => {
        if (value !== null) {
          if (value.status === "success") {
            ...
            console.log("value.new_orders",value.pickup_orders)
    ...
    <div className="card-box">
      <div className="container p-0">
        <div className="row search-box mb-3">
          <h4 className="protitle mb-0">Picked-Up Orders</h4>
          <div className="text-right">
              <CSVLink
                headers={headers}
                data={csvData}
                filename={"AgentPickedupOrdersCargillDelivery.csv"}
                ref={csvLinkEl}
              >
                <button
                  type="button"
