...
export default function AgentAmountCollection(props) {
  ...
  const downloadReport2 = () => {
    ...
    ApiClient.PostApi(ApiUrl.AmountCollections, agent).then((value) => {
      if (value !== null) {
          ...
          <div className="text-center">
            ...
            <div className="text-right">
              <CSVLink
                headers={headers}
                data={csvData}
                filename={"AgentAmountCollectionReportCargillDelivery.csv"}
                ref={csvLinkEl}
              >
                <button
                  type="button"
